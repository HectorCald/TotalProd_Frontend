...
const Verificacion = () => {
  ...
  const handleFiltersChange = (filters) => {
    ...
    const responsable = filters.responsable_id && filters.responsable_id.length > 0 ? { id: filters.responsable_id[0], tipo: 'personal' } : null;
  ...
  useEffect(() => {
    ...
    setIsLoading(true);
    setPage(1);
  }, [debouncedSearch, filtroEstado, filtroResponsable, filtroFecha]);
  ...
  const tableActions = [
    ...
    {
      name: 'Ingresar Producción', 
      icon: 'plus', 
      show: (row) => row.estado === 'verificado',
      onClick: (registro) => {
        // TODO
      }
    }
    ...
    <>
      ...
      <div className={styles.dashboardContainer}>
        ...
        <div className={styles.contentArea} onScroll={handleScroll}>
          <h1 className={styles.title}>Verificar Producción</h1>
          <Tabla
