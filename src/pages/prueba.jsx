    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            if (result.success) {
                ...
                setFormDataLogin(prev => ({
                    ...prev,
                    emailError: result.error || 'Contraseña o correo incorrecto',
                    passwordError: result.error || 'Contraseña o correo incorrecto'
                }));
                setTimeout(() => {
                    setFormDataLogin(prev => ({
                        ...prev,
    ...
    const handleSubmitRegister = async () => {
        if (!formDataRegister.name || !formDataRegister.emailRegister || !formDataRegister.passwordRegister || !formDataRegister.confirmPasswordRegister) {
            ...
            if (!formDataRegister.emailRegister) {
                setFormDataRegister(prev => ({
                    ...prev,
                    emailRegisterError: 'El correo electrónico es requerido'
                }));
            }
            if (!formDataRegister.passwordRegister) {
                setFormDataRegister(prev => ({
                    ...prev,
                    passwordRegisterError: 'La contraseña es requerida'
                }));
            }
            if (!formDataRegister.confirmPasswordRegister) {
                setFormDataRegister(prev => ({
                    ...prev,
                    confirmPasswordRegisterError: 'La confirmación de contraseña es requerida'
                }));
            }
            setTimeout(() => {
                setFormDataRegister(prev => ({
        ...
        if (formDataRegister.passwordRegister.length < 8) {
            setFormDataRegister(prev => ({
                ...prev,
                passwordRegisterError: 'La contraseña debe tener al menos 8 caracteres',
                confirmPasswordRegisterError: 'La contraseña debe tener al menos 8 caracteres'
            }));
            setTimeout(() => {
                setFormDataRegister(prev => ({
                    ...prev,
        ...
        if (!formDataRegister.emailRegister.includes('@') || !formDataRegister.emailRegister.includes('.com')) {
            setFormDataRegister(prev => ({
                ...prev,
                emailRegisterError: 'El correo electrónico no es válido'
            }));
            setTimeout(() => {
                setFormDataRegister(prev => ({
                    ...prev,
        ...
        if (formDataRegister.passwordRegister !== formDataRegister.confirmPasswordRegister) {
            setFormDataRegister(prev => ({
                ...prev,
                confirmPasswordRegisterError: 'Las contraseñas no coinciden'
            }));
        ...
        if (formDataRegister.emailRegister) {
            ...
            try {
                ...
                if (result.success && result.data) {
                    setFormDataRegister(prev => ({
                        ...prev,
                        emailRegisterError: 'El correo electrónico ya está registrado'
                    }));
                    setTimeout(() => {
                        setFormDataRegister(prev => ({
                            ...prev,
