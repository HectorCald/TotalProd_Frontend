        ...
        try {
            ...
            try {
                ...
                if (error.message === 'PERMISSION_DENIED') {
                    ...
                    mostrarNotificacion('error', `⚠️ Permisos de ubicación denegados. Para realizar la venta DEBES permitir el acceso a tu ubicación. ${instrucciones}. Luego presiona "Confirmar Salida" nuevamente.`);
