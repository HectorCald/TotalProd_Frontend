...
function VerProveedor({ isOpen, setIsOpen, usuario }) {
        ...
        <View isOpen={isOpen} setIsOpen={setIsOpen}>
            ...
            <ViewModal isOpen={isDeleteOpen} setIsOpen={setIsDeleteOpen}>
                ...
                <div className={styles.modalContent}>
                    <p className={styles.subTitle}>¿Estás seguro que deseas eliminar al proveedor {usuario?.nombre} ? Esta acción no se puede deshacer.</p>
                    <Boton
                        className='btn-red'
                        label='Si, eliminar'
