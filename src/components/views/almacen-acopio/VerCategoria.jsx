                    ...
                    <div className={styles.buttons}>
                        <Boton
                            ...
                            onClick={async () => {
                                try {
                                    setLoading(true);
                                    const response = await categoryAcopioService.delete(categoria.id);
                                    if (response.success) {
                ...
                <div className={styles.modalContent}>
                    {loadingProducts ? (
                        <NoData 
                            ...
                            detail="Obteniendo productos de esta categoría"
                            transparent={true}
                            minHeight="150px"
                        />
                    ) : products.length > 0 ? (
                        ...
                        <NoData 
                            ...
                            detail="Esta categoría no tiene productos asociados aún"
                            transparent={false}
                            minHeight="150px"
                        />
                    )}
